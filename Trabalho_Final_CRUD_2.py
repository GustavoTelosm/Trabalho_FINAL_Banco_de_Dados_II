...
# =============================================================================
import redis            # Importa a biblioteca para conectar no Redis (Chave-Valor)
import psycopg2         # Importa a biblioteca para conectar no PostgreSQL (Relacional)
from neo4j import GraphDatabase # Importa a classe para conectar no Neo4j (Grafos)
import sys              # Importa funções do sistema (opcional, usado para saídas ou argumentos)

# =============================================================================
# CONFIGURAÇÕES GERAIS (Suas Senhas)
# =============================================================================
...
# =============================================================================
# MÓDULO NEO4J (Banco de Dados Orientado a Grafos)
# =============================================================================
def menu_neo4j():
    ...
    try:
        # Tenta criar a conexão (Driver) usando usuário 'neo4j' e a senha configurada
        ...
        while True:
            ...
            with driver.session() as session:
                ...
                # --- OPÇÃO 3: ATUALIZAR (UPDATE) ---
                    ...
                    nome = input("Nome da pessoa para atualizar: ") # Quem vamos mudar?
                    nova_idade = input("Nova idade: ")              # Qual o novo valor?
...
# =============================================================================
# MÓDULO REDIS (Banco Chave-Valor / Cache)
# =============================================================================
def menu_redis():
    try:
        ...
        while True: # Loop do menu
            ...
            # --- OPÇÃO 1 e 3: CRIAR/ATUALIZAR (SET) ---
            ...
            # --- OPÇÃO 2: LER (GET) ---
                ...
                if valor:
                    ...
                    print("❌ Chave não existe.") # Se retornou None (vazio)
...
# =============================================================================
# MÓDULO POSTGRESQL (Banco Relacional / SQL)
# =============================================================================
def menu_postgres():
    conn = None # Inicializa a variável de conexão vazia
    try:
        # Tenta conectar no banco 'postgres' (padrão) com usuário 'postgres' e sua senha
...
# =============================================================================
# MENU PRINCIPAL (Onde o programa começa)
# =============================================================================
def main():
